...
<div class=" w-[100%] h-[100px] mt-[35px] flex justify-center"><div class="w-[95%] flex justify-between"><h2 class="text-4xl font-[500]">Settings</h2></div></div>
...
<Tabpanel value={value} index={0}><Organization user={user}/></Tabpanel>
<Tabpanel value={value} index={1}><ProfileEditing user={user}/></Tabpanel>
