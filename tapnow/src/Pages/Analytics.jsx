            ...
            <div className="w-[90%]  grid laptop:grid-cols-3 grid-cols-1 gap-x-4 gap-y-4">
              {filtered?.map((elm) => {
                return (
                  <>
                    <div
                      className="h-[150px] w-[300px] border rounded-lg mt-5 shadow-lg flex cursor-pointer"
                      onClick={() => {
                        handleModal(), setuserdata(elm);
                      }}
                    >
                      <div className="h-[100%] w-[50%]  flex flex-col items-center justify-center">
                        <img
                          ...
                          alt="profile"
                          className="h-[70px] w-[70px] rounded-full shadow-sm "
                        />
                        <h2
                          className="font-medium mt-[10px]  w-[100%] text-center"
                          style={
                            elm?.name?.length >= 17
                              ? { marginLeft: "20px" }
                              : null
