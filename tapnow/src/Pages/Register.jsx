...
const Register = () => {
  ...
  return (
    <div className="h-[100vh] w-[100%] border bg-[#f7f7f7]">
      <div className="h-[100%] laptop:w-[49%] bg-white laptop:rounded-r-[50px] shadow-xl  pt-2">
        <div class="w-[100%] flex justify-center items-center ">
          <div class=" text-xl font-medium ml-2 text-gray-400  mr-5">
            T A P N O W
          </div>
          <div class="border h-7 mr-2 border-gray-400"></div>
          <h2 class="text-xl font-medium ml-2 text-gray-400">
        ...
        <div className="w-[100%] mt-1 flex items-center flex-col">
          ...
          <div class="laptop:w-[70%] w-[80%] mt-3">
            <h2 class="text-sm font-medium ">User Name</h2>
            <input
              type="text"
          ...
          <div
            class="mt-5  laptop:w-[50%] w-[70%] h-[40px] bg-black rounded-3xl text-white flex justify-center items-center cursor-pointer"
            onClick={() => addData()}
          >
            Create Account
          </div>
          ...
          <div
            class="mt-3  laptop:w-[50%] w-[70%] h-[40px] text-sm font-medium  rounded-3xl  flex justify-center items-center border cursor-pointer  hover:bg-[#f7f7f7]"
          ...
          <div class="flex mt-3">
            ...
            <Link class="ml-2 font-medium text-[#0b567f]" to="/">
              Login
            </Link>
          </div>
        </div>
